...
},
{
  ...
  "number": "1.1.2",
  "title": "",
  "body": "  Draw the vectors below with given starting and ending points:  (a) and   (b) and    Two vectors drawn in the xy-plane: vector PQ with initial point x = 0, y = 0 and terminal point x = 3, y = 2, and vector RS with initial point x = 0.5, y = 2 and terminal point x = 3.5, y = 4.   What can we say about the vectors and ?     Moving from to we travel 3 units in the direction and 2 units in the direction. Moving from to we travel units in the direction and units in the direction. Since the two arrows describe the same displacement, they have the same magnitude and the same direction; the only difference between them is where they start.   "
},
{
...
},
{
  ...
  "number": "1.1.6",
  "title": "",
  "body": "  Graph the vector with starting point and ending point ; write the vector in standard position; and then graph the vector in standard position.   A vector from P, x = 2, y = 1, to Q, x = -1, y = 0, and the same vector in standard position, namely vector v with coordinates x = -3, y = -1.      Both graphs are shown above. Using the formula, the ending point of the vector in standard position is , so   This is the arrow starting at the origin and ending at : the original vector shifted so that its starting point is the origin.   "
},
{
...
},
{
  ...
  "number": "1.1.16",
  "title": "",
  "body": "  Given and , graph using the Triangle rule.   The Triangle Rule for adding vector v with coordinates x = 1, y = 1 and vector u with coordinates x = 1, y = -2: v is drawn from the origin, u is drawn from the tip of v, and the sum v plus u is drawn from the origin to the tip of u.      Following the Triangle Rule, we first draw in standard position, ending at . Starting at that endpoint we draw , which takes us 1 unit right and 2 units down, ending at . Finally we draw the vector starting at and ending at , which is the sum   in agreement with adding the vectors component-wise, as the graph above shows.   "
},
{
...
},
{
  ...
  "number": "1.1.20",
  "title": "",
  "body": "  Graph the vectors in example 1.7 by first graphing and then using the above note.       We first graph , which has length . For : since , we stretch to a length of keeping its direction, ending at . For : combining (c) with (b) in the note above, we flip the direction of and compress it to a length of , ending at . Both graphs are shown in the figures below.    The vector v with coordinates x = -1, y = 1, and the scaled vector 4 v with coordinates x = -4, y = 4.    The vector v with coordinates x = -1, y = 1, and the scaled vector negative 0.5 v with coordinates x = 0.5, y = -0.5.     "
},
{
...
},
{
  ...
  "number": "1.1.24",
  "title": "",
  "body": "  Given a vector , draw a picture summarizing the information in the definition above.   A vector v with coordinates x = v 1, y = v 2, in standard position with the angle theta from the positive x-axis, showing v 1 equals the magnitude of v times the cosine of theta as the horizontal component and v 2 equals the magnitude of v times the sine of theta as the vertical component.    "
},
{
...
},
{
  ...
  "number": "1.2.11",
  "title": "",
  "body": " Vector   The vector v with coordinates x = 2, y = 5, z = 3, drawn in standard position in xyz-space.   "
},
{
...
},
{
  ...
  "number": "1.3.1",
  "title": "Dot Product.",
  "body": " Dot Product   Let m> and be two vectors in the -plane (or in -space; just add an extra entry). Then the dot product of and , denoted by , is given by: . If and , the dot product can also be written as where , and is the angle between and .   "
},
{
